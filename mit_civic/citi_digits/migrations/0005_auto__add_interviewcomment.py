...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'citi_digits_interviewcomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('comment', self.gf('django.db.models.fields.TextField')()),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('interview', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['citi_digits.Interview'])),
        ))
        db.send_create_signal(u'citi_digits', ['InterviewComment'])


    def backwards(self, orm):
        # Deleting model 'InterviewComment'
        db.delete_table(u'citi_digits_interviewcomment')
