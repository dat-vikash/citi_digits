...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CityDigitsUser.is_superuser'
        db.add_column(u'citi_digits_citydigitsuser', 'is_superuser',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CityDigitsUser.is_superuser'
        db.delete_column(u'citi_digits_citydigitsuser', 'is_superuser')
    ...
    models = {
        ...
        u'citi_digits.interviewcomment': {
            ...
            'commenterClass': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
