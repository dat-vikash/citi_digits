...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InterviewRetailer'
        db.create_table(u'citi_digits_interviewretailer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('storeName', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('do_you_sell_lottery_tickets', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('why_or_why_not_audio', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('customers_in_a_day', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('percentage_buy_lottery_tickets', self.gf('django.db.models.fields.IntegerField')()),
            ('amount_tickets_bought_per_visit', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('why_or_why_not_lottery_neighborhood_audio', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('photo', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'citi_digits', ['InterviewRetailer'])


    def backwards(self, orm):
        # Deleting model 'InterviewRetailer'
        db.delete_table(u'citi_digits_interviewretailer')
