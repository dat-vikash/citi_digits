...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tour.student'
        db.add_column(u'citi_digits_tour', 'student',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['citi_digits.Student']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tour.student'
        db.delete_column(u'citi_digits_tour', 'student_id')
