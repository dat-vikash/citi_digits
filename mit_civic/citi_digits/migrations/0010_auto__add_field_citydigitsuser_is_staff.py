...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CityDigitsUser.is_staff'
        db.add_column(u'citi_digits_citydigitsuser', 'is_staff',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CityDigitsUser.is_staff'
        db.delete_column(u'citi_digits_citydigitsuser', 'is_staff')
